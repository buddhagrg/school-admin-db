...
('Add student', 'users/students/add', NULL, 'user_mgmt_parent', 1, 'menu-screen', NULL, '2'),
('Add staff', 'users/staff/add', NULL, 'user_mgmt_parent', 2, 'menu-screen', NULL, '2'),
('Manage Users', 'users/manage', NULL, 'user_mgmt_parent', 3, 'menu-screen', NULL, '2'),
('Manage Roles & Permissions', 'users/roles-permissions', NULL, 'user_mgmt_parent', 4, 'menu-screen', NULL, '2'),
...
('Get students', 'api/v1/students', NULL, 'user_mgmt_parent', NULL, 'api', 'GET', '2'),
('Add new student', 'api/v1/students', NULL, 'user_mgmt_parent', NULL, 'api', 'POST', '2'),
('Get student detail', 'api/v1/students/:id', NULL, 'user_mgmt_parent', NULL, 'api', 'GET', '2'),
('Handle student status', 'api/v1/students/:id/status', NULL, 'user_mgmt_parent', NULL, 'api', 'POST', '2'),
('Update student detail', 'api/v1/students/:id', NULL, 'user_mgmt_parent', NULL, 'api', 'PUT', '2'),
('Get all staff', 'api/v1/staff', NULL, 'user_mgmt_parent', NULL, 'api', 'GET', '2'),
('Add new staff', 'api/v1/staff', NULL, 'user_mgmt_parent', NULL, 'api', 'POST', '2'),
('Get staff detail', 'api/v1/staff/:id', NULL, 'user_mgmt_parent', NULL, 'api', 'GET', '2'),
('Update staff detail', 'api/v1/staff/:id', NULL, 'user_mgmt_parent', NULL, 'api', 'PUT', '2'),
('Handle staff status', 'api/v1/staff/:id/status', NULL, 'user_mgmt_parent', NULL, 'api', 'POST', '2'),
('Get all roles', 'api/v1/roles', NULL, 'user_mgmt_parent', NULL, 'api', 'GET', '2'),
('Add new role', 'api/v1/roles', NULL, 'user_mgmt_parent', NULL, 'api', 'POST', '2'),
('Switch user role', 'api/v1/roles/switch', NULL, 'user_mgmt_parent', NULL, 'api', 'POST', '2'),
('Update role', 'api/v1/roles/:id', NULL, 'user_mgmt_parent', NULL, 'api', 'PUT', '2'),
('Handle role status', 'api/v1/roles/:id/status', NULL, 'user_mgmt_parent', NULL, 'api', 'POST', '2'),
('Get role detail', 'api/v1/roles/:id', NULL, 'user_mgmt_parent', NULL, 'api', 'GET', '2'),
('Get role permissions', 'api/v1/roles/:id/permissions', NULL, 'user_mgmt_parent', NULL, 'api', 'GET', '2'),
('Add role permissions', 'api/v1/roles/:id/permissions', NULL, 'user_mgmt_parent', NULL, 'api', 'POST', '2'),
('Get role users', 'api/v1/roles/:id/users', NULL, 'user_mgmt_parent', NULL, 'api', 'GET', '2'),
...
('Manage Notices', 'notices/manage', NULL, 'notice_announcement_parent', 3, 'menu-screen', NULL, '2'),
...
('Get notice recipient list', 'api/v1/notices/recipients/list', NULL, 'notice_announcement_parent', NULL, 'api', 'GET', '2'),
('Handle notice status', 'api/v1/notices/:id/status', NULL, 'notice_announcement_parent', NULL, 'api', 'POST', '2'),
('Get notice detail', 'api/v1/notices/:id', NULL, 'notice_announcement_parent', NULL, 'api', 'GET', '2'),
('Get all notices', 'api/v1/notices', NULL, 'notice_announcement_parent', NULL, 'api', 'GET', '2'),
('Add new notice', 'api/v1/notices', NULL, 'notice_announcement_parent', NULL, 'api', 'POST', '2'),
('Update notice detail', 'api/v1/notices/:id', NULL, 'notice_announcement_parent', NULL, 'api', 'PUT', '2'),
...
('Edit Department', 'departments/edit/:id', NULL, 'settings_parent', NULL, 'screen', NULL, '2'),
('Get all departments', 'api/v1/departments', NULL, 'settings_parent', NULL, 'api', 'GET', '2'),
('Add new department', 'api/v1/departments', NULL, 'settings_parent', NULL, 'api', 'POST', '2'),
('Get department detail', 'api/v1/departments/:id', NULL, 'settings_parent', NULL, 'api', 'GET', '2'),
('Update department detail', 'api/v1/departments/:id', NULL, 'settings_parent', NULL, 'api', 'PUT', '2'),
('Delete department', 'api/v1/departments/:id', NULL, 'settings_parent', NULL, 'api', 'DELETE', '2'),
