DROP FUNCTION IF EXISTS public.get_parent_dashboard_data(int, int);

CREATE OR REPLACE FUNCTION public.get_parent_dashboard_data(_school_id int, _user_id int)
RETURNS JSONB
LANGUAGE plpgsql
AS $BODY$
DECLARE
